...
public class MileageData {
	...
	/**
	 * This field is used to format the CSV output of the date
	 * field as a simple MM/DD/YYYY formatted string
	 */
	...
	public static long parseDate(String dt) {
		long loc_dt = 0;
		try {
			Date loc_date = getDateFormatter().parse(dt);
			loc_dt = loc_date.getTime();
		} catch(java.text.ParseException e) {Log.e("TJS","ERROR : "+e.toString());}
		return loc_dt;
	}
